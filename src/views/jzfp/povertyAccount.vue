  ...
  <div id="povertyAccount">
    ...
    <div class="section">
      <div class="formwords" @click="showPopup">
        <img src="http://119.3.196.255:7604/images/iconPic/locate.png" />
      </div>
    ...
    <div class="navBox">
      <div class="oneNav">
        <div class="one" @click="toNewdet">
          <div>
            <img src="http://119.3.196.255:7604/images/iconPic/fptz1.png" />
          </div>
          <p class="onetexts">贫困户</p>
        </div>
        <div class="one aa" @click="todevelopment">
          <div>
            <img src="http://119.3.196.255:7604/images/iconPic/fptz2.png" />
          </div>
          <p class="twotexts">发展现状</p>
        </div>
        <div class="one bb cc" @click="toArchives">
          <div>
            <img src="http://119.3.196.255:7604/images/iconPic/fptz3.png" />
          </div>
          <p>驻村工作队</p>
        </div>
      </div>
    ...
    <div class="content" v-if="list">
      <div class="oneent">
        <div>
          <img src="http://119.3.196.255:7604/images/iconPic/ic_villagedetail_4.png" />
        </div>
        <p>
          <span>2019</span>年
        </p>
    ...
    <div class="information" v-if="list">
      <div class="inNav">
        <div>
          <img src="http://119.3.196.255:7604/images/iconPic/edit.png" />
        </div>
        <p>更多信息</p>
      </div>
      <div class="listBox">
