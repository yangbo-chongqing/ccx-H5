<template>
    <div id="processList">
        <MyHeader :title="'扶贫过程'"/>
        <div class="proBox" v-for="(item , index) in list" :key="index" @click="toNewdet">
...
<script>
    ...
    import { getProcess,getNewsClass } from "../../apis";
    export default {
        name: "processList",
        data() {
            return {
        ...
        methods: {
            ...
            toNewdet(){
                this.$router.push({path:'/processDetails.html'});
            },
        },
        components: {
            MyHeader,
