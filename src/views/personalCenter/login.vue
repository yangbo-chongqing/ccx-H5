<template>
  <div class="login">
    ...
    <div class="footers">
      <router-link to="/register.html?type=find">
        <span>找回密码 |</span>
      </router-link>
...
export default {
  ...
  methods: {
    ...
    login() {
      ...
      //记住密码
      if (this.remember) {
        window.localStorage.hszusername = username;
        window.localStorage.hszpassword = password;
      }
      if (!this.remember) {
        window.localStorage.removeItem("hszusername");
        window.localStorage.removeItem("hszpassword");
      }
      //验证
    ...
    //去注册页面
    goRegister() {
      this.$router.push("/register.html?type=reg");
    },
    //强制登录
    strongLogin() {
      const username = this.username.trim();
  ...
  created() {
    //是否记住密码
    if (window.localStorage.hszusername && window.localStorage.hszpassword) {
      this.username = window.localStorage.hszusername;
      this.password = window.localStorage.hszpassword;
      this.remember = true;
    } else {
      this.username = "";
      this.password = "";
