  ...
  <div id="ApplyTalent">
    ...
    <div>
      ...
      <div class="item">
        <p>
          <i style="padding-right:0.6rem">*</i>
          <span class="fontcolor">申报类型</span>
        </p>
      ...
      <div class="item">
        <p>
          <i style="padding-right:0.6rem">*</i>
          <span class="fontcolor">突出亮点</span>
        </p>
      ...
      <div class="item">
        <p>
          <i style="padding-right:0.6rem">*</i>
          <span class="fontcolor">图片上传</span>
        </p>
        <input type="text" disabled />
      </div>
      <Uploader
      ...
      <Popup v-model="showSex" position="bottom" :style="{ height: '50%' }">
        <Picker
          show-toolbar
          :columns="columnsSex"
          @cancel="onCancelSex"
