    ...
    <div>
      <div class="details-top">
        ...
        <div class="details-user">
          ...
          <div>
            <!-- 剩余：
            <span>{{(Date.parse(data1.end_time)-Date.parse(data1.start_time) )| dateFormat}}</span>天-->
          </div>
        </div>
      </div>
      <div class="line"></div>
    ...
    getVotedetails(news_id) {
      ...
      getVotedetails({
        ...
        if (~~msg.code === 0) {
          ...
          this.time =
            Date.parse(msg.data.data1[0].end_time) -
            Date.parse(msg.data.data1[0].start_time);
        } else {
          //获取失败
